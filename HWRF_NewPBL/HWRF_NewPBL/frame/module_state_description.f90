...
MODULE module_state_description
  ...
  INTEGER, PARAMETER :: gfs2011scheme = 83
  INTEGER, PARAMETER :: gfsedmfscheme = 93
  ...
  INTEGER, PARAMETER :: PARAM_qndrop = 12
  INTEGER            ::     P_qndrop = 1
  LOGICAL            ::     F_qndrop = .FALSE.
  INTEGER, PARAMETER :: PARAM_qrimef = 13
  INTEGER            ::     P_qrimef = 1
  LOGICAL            ::     F_qrimef = .FALSE.
  INTEGER, PARAMETER :: PARAM_qvolh = 14
  INTEGER            ::     P_qvolh = 1
  LOGICAL            ::     F_qvolh = .FALSE.
  INTEGER, PARAMETER :: PARAM_NUM_scalar = 15
