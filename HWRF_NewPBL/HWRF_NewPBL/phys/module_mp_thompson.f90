      ...
      subroutine mp_thompson (qv1d, qc1d, qi1d, qr1d, qs1d, qg1d, ni1d, &
                          nr1d, nc1d, nwfa1d, lpi1d, nifa1d, t1d, p1d, w1d, dzq, &
                          pptrain, pptsnow, pptgraul, pptice, &
      ...
      REAL, DIMENSION(kts:kte):: ql1d
      REAL, DIMENSION(0:kte):: height
      ...
      REAL:: rgvm, delta_tp, orho, lfus2, t_base, t_top, z_full
      ...
      INTEGER:: i, j, k, k2, n, nn, nstep, k_0, kbot, IT, iexfrq
      INTEGER, DIMENSION(5):: ksed1
      INTEGER:: nir, nis, nig, nii, nic, niin, nke, nk
...
11    CONTINUE
      ...
      elseif (satw.ge.0.985 .and. tempc.gt.HGFR-273.15) then
         ...
         xni  = 3.*nifa_cc**(1.25)*exp((0.46*(-tempc))-11.6)             
