...
!-----------------------------------------------------------------------
      subroutine trans2Polar_3D
     &(tp,xlon,ylat,ib,jb,kb,clon,clat,cyl,mt,nt,dnt)
!-----------------------------------------------------------------------
      implicit none
...
!        print*,bi0,bi1,bj0,bj1
      ...
      call hunt(ylat(1,:),jb,y,jlo)
        ...
        do k=1,kb
          if(tp(ilo,jhi,k) > 1.D15 .or. tp(ihi,jhi,k) > 1.D15 .or.
     &       tp(ilo,jlo,k) > 1.D15 .or. tp(ihi,jhi,k) > 1.D15      )then
             cyl(n,m,k)=  9.999E+20
          else
             cyl(n,m,k)=
