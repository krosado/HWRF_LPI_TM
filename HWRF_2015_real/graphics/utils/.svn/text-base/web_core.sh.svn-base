...
<HTML>
  <HEAD>
    <TITLE>2013 Operational HWRF Runs: $storm $yyyy </TITLE>
    ...
    <div class="storm_inventory">
      ...
      <table id="storm_inv_content">
        ...
        <tr><th id="storm_inv_cycname_head" bgcolor = DDEFFF>
         ...
         Simulated MTSAT & Microwave Images
...
echo " <a href=\"${storm}.${date}/par_GOESIR.html\">MTSAT IR</A>" >>index.html
echo "</td>" >>index.html
...
echo " <a href=\"${storm}.${date}/par_GOESWV.html\">MTSAT WV</A>" >>index.html
echo "</td>" >>index.html
...
<html>
<head>
<title>HWRF Coupled Model (2013 Operational Version) Forecast Statistics</title>
</head>
