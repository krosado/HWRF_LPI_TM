...
if [ "$smode" == "NEW" ]; then
 ...
 eline=`cat -n index.html | grep $storm | tail -n 1 | awk '{print $1}'`
 echo "Starting line to change is: $sline"
 echo "Ending line to change is: $eline"
 sed -n ${sline},${eline}p ./index.html > ./log1.txt
 line1=`cat -n index.html.bk | grep $storm | tail -n 1 | awk '{print $1-1}'` 
 line2=`cat -n index.html.bk | grep $storm | tail -n 1 | awk '{print $1+1}'`
 ...
 cp -f ./index.html ./index.html.bk
 sline=`cat -n index.html | grep $start_date | head -n 1 | awk '{print $1}'`
 eline=`cat -n index.html | grep $smode | tail -n 1 | awk '{print $1}'`
 hline=`cat -n index.html | grep storm_inv_content | awk '{print $1}'`
...
#
  ...
  echo "Ending line to change is: $eline"
  sed -n ${sline},${eline}p ./index.html > ./log1.txt
  line1=`cat -n index.html.bk | grep $smode | tail -n 1 | awk '{print $1-1}'`
  line2=`cat -n index.html.bk | grep $smode | tail -n 1 | awk '{print $1+1}'`
  fline=`cat -n index.html.bk | tail -n 1 | awk '{print $1}'`
  sed -n 1,${line1}p ./index.html.bk > ./log2.txt
  sed -n ${line2},${fline}p ./index.html.bk > ./log3.txt
  cat log2.txt > index.html
