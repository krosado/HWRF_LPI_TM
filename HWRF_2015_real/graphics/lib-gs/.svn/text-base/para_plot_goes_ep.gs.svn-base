...
'set ylint 10'
*---------------------------------------------------------------------
* Plot Parent WV Simulated GOES TB
*---------------------------------------------------------------------
...
*'d CNVHRtoa-273.16'
'd var241toa-273.16'
'draw title MC_MODEL STORM stormid Simulated GOES WV TB (K)'
'set string 1 bl 7'
...
'clear'
*---------------------------------------------------------------------
* Plot Parent IR Simulated GOES TB
*---------------------------------------------------------------------
...
*'d CNVMRtoa-273.16'
'd var241toa-273.16'
'draw title MC_MODEL STORM stormid Simulated GOES IR TB (K)'
'set string 1 bl 7'
'set strsiz 0.10 0.10'
'draw string 3.0 8.05 INIT YYYYMMDDHH Z for HOUR h FCST VALID vdate Z'
'run cbarn2.gs 1.0 1 0.50'
