**************************************************************
*  GraDS script - hwrf_gr_plot_intensity_HR12.gs 
**************************************************************
...
*'set timelab on'
  ...
  'd lat*0-'ymax'+'ymin
'draw ylab Intensity (Max. 10m Winds, kts)'
...
'draw string 5.5 8.15 MC_MODEL 2013 Real time: TC Intensity Vmax ' 
'set strsiz 0.18 0.18'
subtitle='Storm: STORMNAME (STID) valid YYYYMMDDHH '
'draw string 5.5 7.7 ' subtitle
'set strsiz 0.12'
'draw string 5.5 0.2 Forecast time (hr)'
**************************************************************
dfile.1=1
if(dfile.1 = 1)
*
...
**************** Connect consecutive points with a line`
  if(flag >0)
   ...
   'draw mark ' mark.6 ' 'xold' 'yold' 0.1'
   'draw mark ' mark.6 ' 'xx' 'yy' 0.1'
   'draw line 'xold' 'yold' 'xx' 'yy
  endif
    xold=xx
    yold=yy
...
**************** Connect consecutive points with a line`
  if(flag >0)
   ...
   'draw mark ' mark.8 ' 'xold' 'yold' 0.1'
   'draw mark ' mark.8 ' 'xx' 'yy' 0.1'
   'draw line 'xold' 'yold' 'xx' 'yy
   endif
    xold=xx
    yold=yy
