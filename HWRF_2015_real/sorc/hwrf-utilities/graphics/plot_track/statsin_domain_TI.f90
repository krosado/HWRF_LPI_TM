...
read(10,'(a10)')
do
read(10,'(6x,f8.2,f7.2)',end=99) alon,alat
...
if(eminlon.lt.0.0) then
wlon = eminlon - 12.0 + 360.
else
wlon = eminlon - 15.0
endif

if(emaxlon.lt.0.0) then
elon = emaxlon + 9.0 + 360. 
else
elon = emaxlon + 15.0
endif

if(eminlon.lt.0.0.and.emaxlon.ge.0.0) then
 elon = elon + 14
 wlon = wlon - 5
endif
