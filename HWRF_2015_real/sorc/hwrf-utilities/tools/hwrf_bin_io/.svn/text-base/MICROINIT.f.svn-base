...
!
      ...
      DO I=1,3
        print *,'read eta_micro_lookup.dat ',I
        READ(1)
      ENDDO
      READ(1) MASSR
        print *,'read eta_micro_lookup.dat MASSR' 
      DO I=1,5
        print *,'read eta_micro_lookup.dat ',I
        READ(1)
      ENDDO
        print *,'before read eta_micro_lookup.dat MASSI' 
      READ(1) MASSI
        print *,'read eta_micro_lookup.dat MASSI' 
      CLOSE(1)
