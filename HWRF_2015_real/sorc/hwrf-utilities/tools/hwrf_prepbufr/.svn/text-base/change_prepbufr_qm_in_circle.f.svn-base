 ...
 1237 FORMAT(' ===> EDTPRP: ALL DROPWINSONDE REPORTS WITHIN A ',
     ...
     $ ' UNFLAGGED ON EVERY LEVEL.'//)
      ...
      DO J = 1,numstorms
         ...
         read (11,21) tcv_center,tcv_storm_id,
     $   tcv_storm_name,tcv_century,tcv_yymmdd,tcv_hhmm,tcv_lat,
     $   tcv_latns,tcv_lon,tcv_lonew,tcv_stdir,tcv_stspd,tcv_pcen,
     $   tcv_penv,tcv_penvrad,tcv_vmax,tcv_vmaxrad
...
C  --------------------------------------------------------------
 ...
 1294 FORMAT(1X,A9,'(storm #',i2,'):: center:',f7.2,'N lat, ',f8.2,
   ...
   21 format (a4,1x,a3,1x,a9,1x,i2,i6,1x,i4,1x,i3,a1,1x,i4,a1,
     $        1x,i3,1x,i3,3(1x,i4),1x,i2,1x,i3)
...
cppppppppppppppp
               IF(RDIST.LE.MAX(MAX(111.,3*RMW(J)),ABS(RRADC)))GO TO 1600
            ENDDO
            GO TO 15
 1600       CONTINUE
