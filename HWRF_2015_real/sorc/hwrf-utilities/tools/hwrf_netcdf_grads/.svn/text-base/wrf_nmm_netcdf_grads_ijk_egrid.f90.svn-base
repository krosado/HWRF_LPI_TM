...
!    call fill_nmm_gridg(temp1,im,jm,tempb,igtypeh)
    call out_grads(temp1,outname,im,jm)
...
!                    pd
  ...
  do j=1,jm
    do i=1,im
       ...
       if(i==im)print *,'pd=', i, j, temp1(i,j), temp1(i-1,j),temp1(i-2,j)
    end do
  end do
!  call fill_nmm_gridg(temp1,im,jm,tempb,igtypeh)
  call out_grads(temp1,outname,im,jm)
...
!  call fill_nmm_gridg(psfc_this,im,jm,tempb,igtypeh)
  call out_grads(psfc_this,outname,im,jm)
...
!                      u
  ...
  do k=1,nsig
   do j=1,jm
    do i=1,im
     temp1(i,j)=temp3(i,j,k)
     if(i==im)print *,'u=', i, j, temp1(i,j),temp1(i-1,j),temp1(i-2,j)
    end do
   end do
!   call fill_nmm_gridg(temp1,im,jm,tempb,igtypev)
   call out_grads(temp1,outname,im,jm)
